...
- For architectural information and system design, check `artifacts/architecture/`
...
1. Place architectural diagrams in `artifacts/architecture/`
2. Place images and branding assets in `artifacts/images/`
